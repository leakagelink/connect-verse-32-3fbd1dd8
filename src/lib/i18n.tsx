...
const en: Dict = {
  ...
  "onb.subtitle": "A few quick details to get started. Chat and calls are free.",
  ...
  "onb.joinCreatorHint": "Get a creator profile with availability and schedule.",
  ...
  "onb.welcome": "Welcome to Talkora! Chat and calls are free 🎉",
